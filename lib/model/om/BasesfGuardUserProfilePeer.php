...
abstract class BasesfGuardUserProfilePeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Gender', 'FirstName', 'LastName', 'Email', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'gender', 'firstName', 'lastName', 'email', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::GENDER, self::FIRST_NAME, self::LAST_NAME, self::EMAIL, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'GENDER', 'FIRST_NAME', 'LAST_NAME', 'EMAIL', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'gender', 'first_name', 'last_name', 'email', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Gender' => 2, 'FirstName' => 3, 'LastName' => 4, 'Email' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'gender' => 2, 'firstName' => 3, 'lastName' => 4, 'email' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::GENDER => 2, self::FIRST_NAME => 3, self::LAST_NAME => 4, self::EMAIL => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'GENDER' => 2, 'FIRST_NAME' => 3, 'LAST_NAME' => 4, 'EMAIL' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'gender' => 2, 'first_name' => 3, 'last_name' => 4, 'email' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
