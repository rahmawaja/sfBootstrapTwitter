 ...
 * @method     sfGuardUserProfileQuery orderByImagePath($order = Criteria::ASC) Order by the image_path column
 *
 ...
 * @method     sfGuardUserProfileQuery groupByImagePath() Group by the image_path column
 *
 ...
 * @method     sfGuardUserProfile findOneByImagePath(string $image_path) Return the first sfGuardUserProfile filtered by the image_path column
 *
 ...
 * @method     array findByImagePath(string $image_path) Return sfGuardUserProfile objects filtered by the image_path column
 *
...
abstract class BasesfGuardUserProfileQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID`, `USER_ID`, `GENDER`, `FIRST_NAME`, `LAST_NAME`, `EMAIL`, `IMAGE_PATH` FROM `sf_guard_user_profile` WHERE `ID` = :p0';
		try {
	...
	public function filterByImagePath($imagePath = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(sfGuardUserProfilePeer::IMAGE_PATH, $imagePath, $comparison);
	}
