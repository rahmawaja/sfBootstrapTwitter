...
abstract class BasesfGuardUserProfile extends BaseObject  implements Persistent
{
	...
	public function setGenre($v)
	{
		...
		if ($this->genre !== $v) {
			$this->genre = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::GENRE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->genre = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			return $startcol + 6; // 6 = sfGuardUserProfilePeer::NUM_HYDRATE_COLUMNS.
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setGenre($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::GENRE)) $criteria->add(sfGuardUserProfilePeer::GENRE, $this->genre);
