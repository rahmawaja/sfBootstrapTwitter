...
abstract class BasesfGuardUserProfile extends BaseObject  implements Persistent
{
	...
	public function setImagePath($v)
	{
		...
		if ($this->image_path !== $v) {
			$this->image_path = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::IMAGE_PATH;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->gender = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			$this->image_path = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->resetModified();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::IMAGE_PATH)) {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setImagePath($arr[$keys[6]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::IMAGE_PATH)) $criteria->add(sfGuardUserProfilePeer::IMAGE_PATH, $this->image_path);
